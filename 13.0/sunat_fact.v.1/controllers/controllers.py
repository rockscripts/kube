...
class SunatEfact(http.Controller):
    ...
    def get_invoice_ordered(self, **kw):
        ...
        try:
            ...
            query = "select id, qr_image, invoice_sequence_number_next, journal_id, amount_total from account_invoice where id = "+str(invoice_id)
            request.cr.execute(query)    
            ...
            response = {"inv_id":account_invoice['id'],"invoice_sequence_number_next":account_invoice['invoice_sequence_number_next'],"qr_image":account_invoice['qr_image'],"journal_name":account_journal['name'],"journal_code":account_journal['code'],"total_letters":total_letters}
